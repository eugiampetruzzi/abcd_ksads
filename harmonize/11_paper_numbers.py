#!/usr/bin/env python3
"""Single source of truth: collate every number the manuscript references into
derivatives/paper_numbers.json. Reads only the CSVs/parquets emitted by the
pipeline; nothing is recomputed ad hoc and nothing references a prior study.
"""
import json
import os
