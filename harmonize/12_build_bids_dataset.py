...
def main():
    ...
    def caseness_informant(status_set, informant):
        if informant == "either":
            cp = L3.build_caseness(base, cw, status_set=status_set,
                                   include_subthreshold=False, informant="parent")
            cy = L3.build_caseness(base, cw, status_set=status_set,
        ...
        return L3.build_caseness(base, cw, status_set=status_set,
    ...
    def caseness_wide(status_set):
        ...
        for inf in ["parent", "youth", "either"]:
            ...
            wide = c.pivot_table(index=["participant_id", "session_id"], columns="category",
            ...
            frames.append(wide[["participant_id", "session_id", "informant"] + DISORDER_CATS])
    ...
    cat_dict = {"participant_id": {"Description": "ABCD participant identifier"},
                ...
                "informant": {"Description": "Report source / combination rule", "Levels": {
