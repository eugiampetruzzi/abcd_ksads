#!/usr/bin/env python3
"""Single-lever sensitivity, recomputed on the multiverse engine/denominator.

Fix a base specification (current, parent, full threshold, phobia-in, baseline)
and flip exactly one lever at a time, reporting any-disorder prevalence and the
percentage-point change. Numbers are internally consistent with the specification
curve (same Layer 3 engine, administered-only denominator).

Output: derivatives/single_lever.csv
"""
